...
elseif( isset($HTTP_GET_VARS['pane']) && $HTTP_GET_VARS['pane'] == 'right' )
{
	...
	*/
    ...
    $version_info = "\n<p style=\"color: green;\">Nessun aggiornamento disponibile per la versione in uso di phpBB.</p>"
                  . "\n<p>La versione in utilizzo &egrave; la phpBB v2.0.24-Dev con i fix del progetto <a href=\"http://salviamophpbb2.webnet32.com\" target=\"_blank\">Salviamo phpBB2</a> ovvero la <b>Reload Version [v2]<b></p>";
