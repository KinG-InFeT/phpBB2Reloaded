...
if( $mode != "" )
{
	...
	else if( $mode == "save" )
	{
		...
		//
		// Fix XSS By KinG-InFeT
		//
		
		$rank_id = ( isset($HTTP_POST_VARS['id']) ) ? intval($HTTP_POST_VARS['id']) : 0;
		$rank_title = ( isset($HTTP_POST_VARS['title']) ) ? htmlspecialchars(trim($HTTP_POST_VARS['title'])) : "";
		...
		$rank_image = ( (isset($HTTP_POST_VARS['rank_image'])) ) ? htmlspecialchars(trim($HTTP_POST_VARS['rank_image'])) : "";
