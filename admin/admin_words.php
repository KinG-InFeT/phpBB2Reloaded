...
if( $mode != "" )
{
	...
	else if( $mode == "save" )
	{
		...
		$word = ( isset($HTTP_POST_VARS['word']) ) ? htmlspecialchars(trim($HTTP_POST_VARS['word'])) : "";
		$replacement = ( isset($HTTP_POST_VARS['replacement']) ) ? htmlspecialchars(trim($HTTP_POST_VARS['replacement'])) : "";
