...
<table border="0" cellpadding="2" cellspacing="1" width="100%" class="forumline">
	...
	<tr>
		...
		<td class="row1" align="center"><span class="gensmall">{topicrow.REPLIES}</span></td>
		<td class="row2" align="center" nowrap="nowrap"><span class="gensmall">&nbsp;{topicrow.TOPIC_AUTHOR}&nbsp;</span></td>
