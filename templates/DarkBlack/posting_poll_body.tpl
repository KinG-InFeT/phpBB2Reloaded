...
<tr>
<td align="right" class="row1"><span class="explaintitle">{L_POLL_OPTION}:</span></td>
<td class="row2"><span class="genmed"><input type="text" name="add_poll_option_text" size="50" maxlength="255" class="post" value="{ADD_POLL_OPTION}" /></span> &nbsp;<input type="submit" name="add_poll_option" value="{L_ADD_OPTION}" class="mainoption" /></td>
</tr>
<tr>
